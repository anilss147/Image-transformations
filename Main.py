...
images_path="/content/drive/MyDrive/SACK_THURSDAY2" #path to original images
augmented_path="/content/drive/MyDrive/SACK_THURSDAY2" # path to store aumented images
